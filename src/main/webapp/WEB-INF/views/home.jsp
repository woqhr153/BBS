			...
			<table class="table table-hover" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						...
						<th style="background-color: #eeeeee; text-align: center; width:35%;">제목</th>
						...
						<th style="background-color: #eeeeee; text-align: center; width:20%;">수정일</th>
					</tr>
				</thead>
				<tbody id="boardList">
				...
				<tr>
					<td>${list.bbs_id}</td>
					<td><div id="title" style="overflow: hidden;
  text-overflow: ellipsis;
  white-space: nowrap;
  width: 250px;
  height: 20px;">${list.title}</div></td>
					<td>${list.writer}</td>
					<td>${list.created}</td>
					<td>${list.updated}</td>
				</tr>
